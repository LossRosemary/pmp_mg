...
<div class="wrapper">
	...
	<footer class="main-footer">
		...
		<strong>Copyright &copy; 2020 <a href="http://www.king.cn">wyu</a>.</strong> All rights reserved.
	</footer>
	<!-- 底部导航 /-->
...
<script>
	function changePageSize() {
		...
		//向服务器发送请求，改变每页显示条数
		location.href = "${pageContext.request.contextPath}/product/findAll?page=${pageInfo.pageNum}&size="
				+ pageSize;
	}
	...
	$(document).ready(function() {
		...
		// 列表按钮
		$("#dataList").find("td input[type='checkbox']").iCheck(
				{
		...
		$("#selall").click(function() {
			...
			if (!clicks) {
				$("#dataList").find("td input[type='checkbox']").iCheck("uncheck");
			} else {
				$("#dataList").find("td input[type='checkbox']").iCheck("check");
			}
